...
export const FILM_COVER_URL =
  "https://starwars-visualguide.com/assets/img/films";

export const PILOT_PICTURE_URL =
  "https://starwars-visualguide.com/assets/img/characters";

export const STARSHIP_PICTURE_URL =
  "https://ik.imagekit.io/p4ls2huzsz/belifkutlu/starships";

export const PLANET_PICTURE_URL =
  "https://starwars-visualguide.com/assets/img/planets";

export const STARSHIP_PICTURE_2_URL =
  "https://starwars-visualguide.com/assets/img/starships";

export const VEHICLE_PICTURE_URL =
  "https://starwars-visualguide.com/assets/img/vehicles";

export const SPECIES_PICTURE_URL =
